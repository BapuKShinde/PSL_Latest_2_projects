...
public class DestinationPointRFIDHandler  implements Readers.RFIDReaderEventHandler {
    ...
    // UI and context
    TextView textStatus;
    private DestinationPointActivity context;
    // general
    ...
    void onCreate(DestinationPointActivity activity) {
        // application context
        context = activity;
        // SDK
        InitSDK();
