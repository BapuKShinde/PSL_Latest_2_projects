...
class RFIDHandler implements Readers.RFIDReaderEventHandler {
    ...
    public String ReadAccess() {
        ...
        try {
            ...
            nfe.printStackTrace();
            Log.e("RFID_SAMPLE","Password field is empty or invalid !");
            // Toast.makeText(this, "Password field is empty or invalid !", Toast.LENGTH_SHORT).show();
        }
        readAccessParams.setCount(Integer.parseInt("15"));

       // readAccessParams.setMemoryBank(GetAccessRWMemoryBank());

        readAccessParams.setOffset(Integer.parseInt("2"));

       // readAccessParams.setByteCount(Integer.parseInt("15"));

        //readAccessParams.setMemoryBank(MEMORY_BANK.MEMORY_BANK_EPC);

       // readAccessParams.setByteOffset(Integer.parseInt("2"));
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... voids) {
                try {
                    final TagData tagData = reader.Actions.TagAccess.readWait("0800", readAccessParams, null,false);
                    //handle
                   ...
                   // e.printStackTrace();
                    //Log.e("RFID_SAMPLE","INVALID : "+e.getMessage());
                    return "a";
                } catch (OperationFailureException e) {
                    operationFailureException = e;
                    //e.printStackTrace();
                    //Log.e("RFID_SAMPLE","OPERATION : "+e.getLocalizedMessage());
                    return "a";
                }
               //return "a";
            }
            ...
            protected void onPostExecute(String result) {
                ...
                if (invalidUsageException != null) {
                    // progressDialog.dismiss();/ sendNotification(Constants.ACTION_READER_STATUS_OBTAINED, invalidUsageException.getInfo());
                                  ...
                                  //  TextView accessRWData = (TextView) findViewById(R.id.accessRWData);
                                   ...
                                   // }
                                    ...
                                    //((AccessOperationsFragment) fragment).setStartStopTriggers();
                                            ...
                                            //isAccessCriteriaRead = true;

                                    TagAccess tagAccess = new TagAccess();
                                    final TagAccess.ReadAccessParams readAccessParams = tagAccess.new ReadAccessParams();
                                    try {
                                        readAccessParams.setAccessPassword(Long.decode("0X" + "00000000"));
                                    } catch (NumberFormatException nfe) {
                                        nfe.printStackTrace();
                                       // Toast.makeText(this, "Password field is empty or invalid !", Toast.LENGTH_SHORT).show();
                                    }
                                    readAccessParams.setByteCount(Integer.parseInt("6"));
                                    ...
                                    new AsyncTask<Void, Void, Boolean>() {
                                        ...
                                        protected Boolean doInBackground(Void... voids) {
                                            try {
                                                final TagData tagData = reader.Actions.TagAccess.readWait(tagId, readAccessParams, null);
                                               //handle
                                            } catch (InvalidUsageException e) {
                                                invalidUsageException = e;
                                                e.printStackTrace();
