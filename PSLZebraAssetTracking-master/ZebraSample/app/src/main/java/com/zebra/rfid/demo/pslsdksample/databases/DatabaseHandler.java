package com.zebra.rfid.demo.pslsdksample.databases;
...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public ArrayList<TasksModal> getAllSourceByTransactionTypesAndMaterial(String transaction_id,String material) {
        ...
        String selectQuery = "SELECT  DISTINCT "+DB_TASK_SOURCE_LOCATION +" FROM " + TABLE_TASKS +" WHERE "+DB_TASK_TRANSACTION_TYPE +" = '"+transaction_id+"' AND "+DB_TASK_PRODUCT +" = '"+material+"' AND "+DB_TASK_SOURCE_LOCATION +" != ''  AND IsActive = 'true'" ;
        Cursor cursor = db.rawQuery(selectQuery, null);
    ...
    public ArrayList<TasksModal> getAllDestinationByTransactionTypesAndMaterialAndSource(String transaction_id,String material,String source) {
        ...
        String selectQuery = "SELECT  DISTINCT "+DB_TASK_DESTINATION_LOCATION + " FROM " + TABLE_TASKS +" WHERE "+DB_TASK_TRANSACTION_TYPE +" = '"+transaction_id+"' AND "+DB_TASK_PRODUCT +" = '"+material+"' AND "+DB_TASK_SOURCE_LOCATION +" = '"+source+"' AND "+DB_TASK_DESTINATION_LOCATION+" !=''  AND IsActive = 'true'" ;
        Cursor cursor = db.rawQuery(selectQuery, null);
    ...
    public String getTaskNumber(String transaction_id,String material,String source,String destination) {
        String task_number = "";
        SQLiteDatabase db = this.getWritableDatabase();

        String selectQuery = "SELECT  "+DB_TASK_NUMBER +" FROM Tasks_Table WHERE "+DB_TASK_TRANSACTION_TYPE +" = '"+transaction_id+"' AND "+DB_TASK_PRODUCT +" = '"+material+"' AND "+DB_TASK_SOURCE_LOCATION +" = '"+source+"' AND "+DB_TASK_DESTINATION_LOCATION +" = '"+destination+"'" ;
        Cursor cursor = db.rawQuery(selectQuery, null);
