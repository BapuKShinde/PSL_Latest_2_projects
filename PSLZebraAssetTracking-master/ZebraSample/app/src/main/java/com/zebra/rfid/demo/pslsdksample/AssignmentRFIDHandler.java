...
public class AssignmentRFIDHandler implements Readers.RFIDReaderEventHandler {
    ...
    // UI and context
    TextView textStatus;
    private AssignmentActivity context;
    // general
    ...
    void onCreate(AssignmentActivity activity) {
        // application context
        context = activity;
        // SDK
        InitSDK();
