...
public class LoadRFIDHandler implements Readers.RFIDReaderEventHandler {
    ...
    void onCreate(LoadActivity activity) {
        // application context
        context = activity;
        // SDK
        InitSDK();
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... voids) {
                try {
                    ...
                    return "a";
                   // return "101000010010011010000101010010001011010011101010001101110000000000000000000000000000000000000000000000000";
    ...
    private void InitSDK() {
        Log.d(TAG, "InitSDK");
        if (readers == null) {
            new LoadRFIDHandler.CreateInstanceTask().execute();
        } else
            new LoadRFIDHandler.ConnectionTask().execute();
    }
