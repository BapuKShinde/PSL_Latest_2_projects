...
public class BaseUhfLowForWriteActivity extends AppCompatActivity {
    ...
    public class InitTask extends AsyncTask<String, Integer, Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (!result) {
                ...
                Toast.makeText(BaseUhfLowForWriteActivity.this, "init fail",
                        Toast.LENGTH_SHORT).show();
            }else{
                mReader.setPower(12);
                SharedPreferencesManager.setSavedPower(context,12);
        ...
        protected void onPreExecute() {
            ...
            mypDialog = new ProgressDialog(BaseUhfLowForWriteActivity.this);
