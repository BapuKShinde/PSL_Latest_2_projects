...
public class BaseSearchUHFActivity extends AppCompatActivity {
    ...
    public class InitTask extends AsyncTask<String, Integer, Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (!result) {
                ...
                Toast.makeText(BaseSearchUHFActivity.this, "init fail",
                        Toast.LENGTH_SHORT).show();
            }else{
                mReader.setPower(30);
                // mReader.setFilter(RFIDWithUHF.BankEnum.UII,32,0,"",false);
        ...
        protected void onPreExecute() {
            ...
            mypDialog = new ProgressDialog(BaseSearchUHFActivity.this);
