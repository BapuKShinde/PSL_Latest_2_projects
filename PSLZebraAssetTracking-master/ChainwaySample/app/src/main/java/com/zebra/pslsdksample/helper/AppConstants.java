...
public class AppConstants {
    ...
    public static String DESTINATION_POINT_UPLOAD_TOUCH_POINT = "D";//Production "D" debug "X"
    public static String CAST_ASSIGNMENT_UPLOAD_TOUCH_POINT = "M";//Production "M" debug "V"
    public static String LOAD_UPLOAD_TOUCH_POINT = "M";//Production "M" debug V
    ...
    public static final String GET_MATERIAL_DETAILS_FOR_TRUCK_NUMBER = "/api/Tripdetails?truckId=";
    ...
    public static final String POST_LOAD_TRIPDETAILS = "/PDA/TripDetail";
...
public static final int EPC_FROM = 2;
public static final int EPC_LENGTH = 15;
