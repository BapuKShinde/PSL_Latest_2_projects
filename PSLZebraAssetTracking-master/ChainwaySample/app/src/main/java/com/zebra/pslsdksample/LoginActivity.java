...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        askForPermission(Manifest.permission.ACCESS_COARSE_LOCATION, 103);
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(SharedPreferencesManager.getIsHostConfig(context)){
                    ...
                    ApplicationCommonMethods.showCustomErrorDialog(context,getResources().getString(R.string.url_not_config));
                }
    ...
    private void askForPermission(String permission, Integer requestCode) {
        ...
        } else if (ContextCompat.checkSelfPermission(LoginActivity.this, permission) == PackageManager.PERMISSION_DENIED) {
