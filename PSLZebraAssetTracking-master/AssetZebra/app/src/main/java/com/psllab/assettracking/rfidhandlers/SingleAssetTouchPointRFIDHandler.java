...
import com.psllab.assettracking.TouchpointAssetScanActivity;
...
public class SingleAssetTouchPointRFIDHandler implements Readers.RFIDReaderEventHandler {
    ...
    // UI and context
    TextView textView;
    private TouchpointAssetScanActivity context;
    // general
    ...
    public void onCreate(TouchpointAssetScanActivity activity) {
        // application context
        context = activity;
        // Status UI
