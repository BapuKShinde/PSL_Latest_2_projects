...
import com.psllab.assettracking.SingleAssetScanActivity;
...
public class SingleAssetScanRFIDHandler implements Readers.RFIDReaderEventHandler {
    ...
    private SingleAssetScanRFIDHandler.EventHandler eventHandler;
    // UI and context


    TextView textView;
    private SingleAssetScanActivity context;
    // general
    //private int MAX_POWER = 270;
    private int MAX_POWER = 90;
    // In case of RFD8500 change reader name with intended device below from list of paired RFD8500
    String readername = "RFD8500123";

    public void onCreate(SingleAssetScanActivity activity) {
        // application context
        context = activity;
        // Status UI
