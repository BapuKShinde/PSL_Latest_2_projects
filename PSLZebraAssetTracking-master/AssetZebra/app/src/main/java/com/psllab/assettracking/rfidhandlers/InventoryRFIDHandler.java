...
import com.psllab.assettracking.AssetInventoryActivity;
...
public class InventoryRFIDHandler implements Readers.RFIDReaderEventHandler {
    ...
    // UI and context
    TextView textView;
    private AssetInventoryActivity context;
    // general
    ...
    public void onCreate(AssetInventoryActivity activity) {
        // application context
        context = activity;
        // Status UI
    ...
    public String ReadAccess() {
        ...
        readAccessParams.setByteCount(Integer.parseInt("2"));
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... voids) {
                try {
                    final TagData tagData = reader.Actions.TagAccess.readWait("0800", readAccessParams, null);
                    //handle
